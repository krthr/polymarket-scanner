# real-polymarket-listings Specification

## Purpose
Define the production contract for loading only real Polymarket listings, enriching them with public CLOB books, and keeping fixture data isolated to deterministic tests.
